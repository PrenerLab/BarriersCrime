...
import delimited badData.csv, varnames(1)
...
export delimited using yesiLeads.csv, replace
clear
//==============================================================================
...
export delimited using yesCAD.csv, replace
clear
//==============================================================================
...
export delimited using intersection.csv, replace
clear
...
export delimited using location.csv, replace
clear
//==============================================================================
...
export delimited using noSpatial.csv, replace
clear
